...
abstract class AbstractPseudonymServiceType extends AbstractWebServiceDescriptorType
{
    ...
    public const string XSI_TYPE_NAME = 'PseudonymServiceType';
     ...
     * @param \SimpleSAML\WebServices\Federation\XML\fed\PseudonymServiceEndpoint[] $pseudonymServiceEndpoint
     * @param (
     ...
     *
     * @return \SimpleSAML\WebServices\Federation\XML\fed\PseudonymServiceEndpoint[]
     */
