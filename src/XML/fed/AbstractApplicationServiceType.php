...
abstract class AbstractApplicationServiceType extends AbstractWebServiceDescriptorType
{
    ...
    public const string XSI_TYPE_NAME = 'ApplicationServiceType';
     ...
     * @param \SimpleSAML\WebServices\Federation\XML\fed\ApplicationServiceEndpoint[] $applicationServiceEndpoint
     * @param (
     ...
     *
     * @return \SimpleSAML\WebServices\Federation\XML\fed\ApplicationServiceEndpoint[]
     */
