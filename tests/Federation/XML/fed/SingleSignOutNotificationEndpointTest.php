...
use SimpleSAML\WebServices\Federation\XML\fed\SingleSignOutNotificationEndpoint;
...
final class SingleSignOutNotificationEndpointTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::FromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed/SingleSignOutNotificationEndpoint.xml',
        );
