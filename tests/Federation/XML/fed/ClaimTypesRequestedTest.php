...
use SimpleSAML\WebServices\Federation\XML\fed\AbstractClaimTypesRequestedType;
use SimpleSAML\WebServices\Federation\XML\fed\AbstractFedElement;
use SimpleSAML\WebServices\Federation\XML\fed\ClaimTypesRequested;
...
/**
 * Class \SimpleSAML\WebServices\Federation\XML\fed\ClaimTypesRequestedTest
 *
...
final class ClaimTypesRequestedTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed/ClaimTypesRequested.xml',
        );
    }
