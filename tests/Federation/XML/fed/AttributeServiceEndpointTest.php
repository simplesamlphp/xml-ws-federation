...
use SimpleSAML\WebServices\Federation\XML\fed\AttributeServiceEndpoint;
 ...
 *
 * @covers \SimpleSAML\WebServices\Federation\XML\fed\AttributeServiceEndpoint
 * @covers \SimpleSAML\WebServices\Federation\XML\fed\AbstractEndpointType
...
final class AttributeServiceEndpointTest extends TestCase
{
    ...
    /** @var \Dom\Element $referenceParameters */
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::FromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed/AttributeServiceEndpoint.xml',
        );
