...
use SimpleSAML\WebServices\Federation\XML\fed\SingleSignOutSubscriptionEndpoint;
...
final class SingleSignOutSubscriptionEndpointTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::FromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed/SingleSignOutSubscriptionEndpoint.xml',
        );
