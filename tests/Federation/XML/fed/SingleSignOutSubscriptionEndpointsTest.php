...
use SimpleSAML\WebServices\Federation\XML\fed\SingleSignOutSubscriptionEndpoints;
...
final class SingleSignOutSubscriptionEndpointsTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::FromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed/SingleSignOutSubscriptionEndpoints.xml',
        );
